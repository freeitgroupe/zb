        ...
        <div class="choiceIndex clear">
            <div class="choiceLoop clear">
                <div class="breadCrumbs clear">
                    <?=$breadcrumbs?>
                    <div class="breadCats clear right">
                        <select id="catsNav">
                            <?php if($catsAllLevelTreeString):?>
                            <?=$catsAllLevelTreeString?>
                            <?php endif; ?>
                        </select>
                    </div>
                </div>
                ...
                <div id="content-product">
                    <h1 style="text-align:center; height: 100vh;margin-top: 30px;color: #1da6b8;">Category is empty!</h1>
                </div>
                <?php endif;?>
            </div>
        </div>
