<?php require_once "header.php"?>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                <div class="col-xs-3">
                    <a href="/admin/edit-category-news/new" class="btn btn-default">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                        <!-- /.box-header -->
                        <div class="box-body">
                            <?php if(isset($get_edit_category_news)):?>
                                <table id="table-pages" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                    <?php for($i=0, $count=count($get_edit_category_news); $i<$count; $i++):?>
                                        <tr class=" pg-<?=$get_edit_category_news[$i]['id']?>">
                                            <td>
                                                <p><?=$get_edit_category_news[$i]['title']?></p>
                                            </td>
                                            <td>
                                                <a href="/admin/edit-category-news/<?=$get_edit_category_news[$i]['id']?>" class="btn btn-default btn-warning" >Редактировать</a>
                                                <a href="#" data-toggle="modal" data-target="#modal-pages-action" class="btn btn-default btn-danger btn-delete-pages" data-page="<?=$get_edit_category_news[$i]['id']?>">Удалить</a>
                                                <button href="" data-toggle="modal" data-target="#modal-pages-action" class="btn btn-default btn-success btn-show-pages b-s-p-<?=$get_edit_category_news[$i]['id']?>" data-page="<?=$get_edit_category_news[$i]['id']?>" <?php if($get_edit_category_news[$i]['view'] == 1):?>disabled<?php endif?>>
                                                    <i class="fa fa-eye"></i>
                                                </button>
                                                <button href="" data-toggle="modal" data-target="#modal-pages-action" class="btn btn-default btn-danger btn-hide-pages b-h-p-<?=$get_edit_category_news[$i]['id']?>" data-page="<?=$get_edit_category_news[$i]['id']?>"  <?php if($get_edit_category_news[$i]['view'] == 0):?>disabled<?php endif?>>
