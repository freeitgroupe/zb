...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Окт 26 2018 г., 14:57
...
(10, 'test1610', '2018-10-15 00:00:00', '2018-10-17 00:00:00', 0, 1);
...
CREATE TABLE `discount_code` (
  ...
  `status_active` enum('0','1') NOT NULL DEFAULT '0' COMMENT '(''0'' - disabled; ''1'' - enabled)'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Дамп данных таблицы `discount_code`
--

INSERT INTO `discount_code` (`id`, `number`, `discount_id`, `status_active`) VALUES
(2, '6d5kjAi299Ll', 10, '0');
...
--
-- Ограничения внешнего ключа таблицы `discount_code`
--
ALTER TABLE `discount_code`
  ADD CONSTRAINT `discount_code_ibfk_1` FOREIGN KEY (`discount_id`) REFERENCES `discount` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
